...
class IncompleteCloudWatchConfig extends Exception
{
     ...
     * @param  Throwable|null  $previous  The previous throwable for chaining (default: null)
     */
    public function __construct(string $message = 'Incomplete CloudWatch configuration', int $code = 0, ?Throwable $previous = null)
    {
